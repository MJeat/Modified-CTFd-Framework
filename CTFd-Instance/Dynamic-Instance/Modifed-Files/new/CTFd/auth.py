import requests
import re   # Added for updating registration form
...
def register():
    ...
    if request.method == "POST":
        ...
        if not email_address.endswith("@aupp.edu.kh"):
            errors.append(_l("Only @aupp.edu.kh email addresses are allowed to register."))
        # --------------------------------
